...
def cria_tabela(número_de_linhas, número_de_colunas):

    tabela = []

    for índice_linha in range(número_de_linhas):
        nova_linha = []
        for índice_coluna in range(número_de_colunas):
            nova_linha.append(0)
